...
public class PersonAdapter extends RecyclerView.Adapter {
    public static interface OnRecyclerViewListener {
        ...
        void onAgeTextClick(int position);
...
//        不知道为什么在xml设置的“android:layout_width="match_parent"”无效了，需要在这里重新设置
    ...
    class PersonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void onClick(View v) {
            if (v.getId()==R.id.recycler_view_test_item_person_view) {
                onRecyclerViewListener.onItemClick(this.getPosition());
            }

            if(v.getId()==R.id.recycler_view_test_item_person_age_tv){
                onRecyclerViewListener.onAgeTextClick(this.getPosition());
            }
        }
